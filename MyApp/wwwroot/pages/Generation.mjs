                ...
                <div v-if="selectedArtifact" class="bg-white dark:bg-gray-800">
                    ...
                    <div class="mb-4">
                        <div class="flex flex-wrap gap-2">
                            ...
                            <!-- Categories Section -->
                            <RouterLink :to="{ path:'/images', query: { category } }" v-for="(score, category) in selectedArtifact.categories ?? {}"
                                  :key="'cat-' + category"
                    ...
                    <div v-if="Object.keys(selectedArtifact.tags ?? {}).length > 0">
                        <div class="flex flex-wrap gap-2">
                            <RouterLink :to="{ path:'/images', query: { tag } }"  v-for="(score, tag) in selectedArtifact.tags ?? {}"
                                  :key="'tag-' + tag"
